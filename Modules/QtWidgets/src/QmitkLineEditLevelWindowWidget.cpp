  ...
  : QWidget(parent, f)
{
  ...
  m_LevelInput->setToolTip(tr("Edit this field to change the center of the levelwindow."));
  ...
  m_WindowInput->setToolTip(tr("Edit this field to change the span of the levelwindow. This number describes the whole span around the center."));
